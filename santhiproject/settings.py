"""
Django settings for santhiproject project.
...
SECRET_KEY = 'django-insecure-e@ml+i0ice1ko_yh!(-^eh-7)tpptdav!jih4*6f%0xx4%e9l%'
...
ROOT_URLCONF = 'santhiproject.urls'
...
WSGI_APPLICATION = 'santhiproject.wsgi.application'
